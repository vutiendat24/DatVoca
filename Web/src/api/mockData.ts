...
export const mockVocabulary: Vocabulary[] = [
  { id: 'v1', word: 'ambiguous', ipa: '/æmˈbɪɡ.ju.əs/', meaning: 'Mơ hồ, có nhiều nghĩa', exampleEn: 'The ending of the movie was ambiguous.', exampleVi: 'Kết thúc của bộ phim rất mơ hồ.', topicId: '6', topicName: 'Academic', difficulty: Difficulty.Medium, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v2', word: 'ephemeral', ipa: '/ɪˈfem.ər.əl/', meaning: 'Phù du, chóng tàn, tồn tại thời gian ngắn', exampleEn: 'Fame in social media is often ephemeral.', exampleVi: 'Sự nổi tiếng trên mạng xã hội thường thoáng qua.', topicId: '6', topicName: 'Academic', difficulty: Difficulty.Hard, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v3', word: 'itinerary', ipa: '/aɪˈtɪn.ər.er.i/', meaning: 'Hành trình, lịch trình du lịch', exampleEn: 'She carefully planned her itinerary for the trip.', exampleVi: 'Cô ấy lên kế hoạch hành trình cẩn thận cho chuyến đi.', topicId: '1', topicName: 'Travel', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v4', word: 'algorithm', ipa: '/ˈæl.ɡə.rɪð.əm/', meaning: 'Thuật toán', exampleEn: "Google's search algorithm is highly sophisticated.", exampleVi: 'Thuật toán tìm kiếm của Google rất tinh vi.', topicId: '2', topicName: 'Technology', difficulty: Difficulty.Hard, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v5', word: 'benevolent', ipa: '/bəˈnev.əl.ənt/', meaning: 'Nhân từ, rộng lượng', exampleEn: 'The benevolent donor funded the new library.', exampleVi: 'Nhà tài trợ hào phóng đã tài trợ cho thư viện mới.', topicId: '5', topicName: 'Daily Life', difficulty: Difficulty.Medium, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v6', word: 'innovation', ipa: '/ˌɪn.əˈveɪ.ʃən/', meaning: 'Sự đổi mới, sự cách tân', exampleEn: 'Innovation drives the tech industry forward.', exampleVi: 'Đổi mới thúc đẩy ngành công nghệ tiến lên.', topicId: '2', topicName: 'Technology', difficulty: Difficulty.Easy, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v7', word: 'resilient', ipa: '/rɪˈzɪl.i.ənt/', meaning: 'Kiên cường, mau phục hồi', exampleEn: 'She is remarkably resilient in the face of adversity.', exampleVi: 'Cô ấy rất kiên cường trước nghịch cảnh.', topicId: '5', topicName: 'Daily Life', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v8', word: 'paradigm', ipa: '/ˈpær.ə.daɪm/', meaning: 'Mô hình, kiểu mẫu', exampleEn: 'This project represents a paradigm shift in the industry.', exampleVi: 'Dự án này đại diện cho sự thay đổi mô hình trong ngành.', topicId: '3', topicName: 'Business', difficulty: Difficulty.SuperHard, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v9', word: 'commute', ipa: '/kəˈmjuːt/', meaning: 'Đi lại, đi làm hàng ngày (bằng phương tiện)', exampleEn: 'He commutes to work by train every day.', exampleVi: 'Anh ấy đi làm bằng tàu mỗi ngày.', topicId: '5', topicName: 'Daily Life', difficulty: Difficulty.Easy, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v10', word: 'hypothesis', ipa: '/haɪˈpɒθ.ə.sɪs/', meaning: 'Giả thuyết', exampleEn: 'The scientist tested her hypothesis in the lab.', exampleVi: 'Nhà khoa học kiểm tra giả thuyết của mình trong phòng thí nghiệm.', topicId: '4', topicName: 'Science', difficulty: Difficulty.Hard, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v11', word: 'turbulence', ipa: '/ˈtɜː.bjʊ.ləns/', meaning: 'Sự nhiễu loạn không khí, sự hỗn loạn', exampleEn: 'The pilot warned passengers about expected turbulence.', exampleVi: 'Phi công cảnh báo hành khách về nhiễu loạn dự kiến.', topicId: '1', topicName: 'Travel', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
  { id: 'v12', word: 'synergy', ipa: '/ˈsɪn.ə.dʒi/', meaning: 'Sức mạnh hiệp đồng, hợp lực', exampleEn: 'The merger created a powerful synergy between both companies.', exampleVi: 'Vụ sáp nhập tạo ra sức mạnh hiệp đồng mạnh mẽ giữa hai công ty.', topicId: '3', topicName: 'Business', difficulty: Difficulty.Hard, isLearned: false, createdAt: yesterday, updatedAt: yesterday },
  { id: 'v13', word: 'catalyst', ipa: '/ˈkæt.ə.lɪst/', meaning: 'Chất xúc tác, tác nhân thay đổi', exampleEn: 'The new policy acted as a catalyst for economic growth.', exampleVi: 'Chính sách mới đóng vai trò như chất xúc tác cho tăng trưởng kinh tế.', topicId: '4', topicName: 'Science', difficulty: Difficulty.Hard, isLearned: false, createdAt: yesterday, updatedAt: yesterday },
  { id: 'v14', word: 'eloquent', ipa: '/ˈel.ə.kwənt/', meaning: 'Hùng hồn, có tài hùng biện', exampleEn: 'She delivered an eloquent speech at the conference.', exampleVi: 'Cô ấy đã có bài phát biểu hùng hồn tại hội nghị.', topicId: '6', topicName: 'Academic', difficulty: Difficulty.Medium, isLearned: true, createdAt: today, updatedAt: today },
  { id: 'v15', word: 'meticulous', ipa: '/məˈtɪk.jʊ.ləs/', meaning: 'Tỉ mỉ, kỹ càng', exampleEn: 'The artist was meticulous in her brushwork.', exampleVi: 'Nghệ sĩ rất tỉ mỉ trong từng nét cọ.', topicId: '6', topicName: 'Academic', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
];

// ─── Sentences ────────────────────────────────────────────────────────────────
export const mockSentences: Sentence[] = [
  { id: 's1', english: 'The quick brown fox jumps over the lazy dog.', vietnamese: 'Con cáo nâu nhanh nhẹn nhảy qua con chó lười biếng.', topicId: '5', topicName: 'Daily Life', difficulty: Difficulty.Easy, isLearned: true, createdAt: today, updatedAt: today },
  { id: 's2', english: 'Success is not final, failure is not fatal: it is the courage to continue that counts.', vietnamese: 'Thành công không phải là cuối cùng, thất bại không phải là chết người: lòng can đảm tiếp tục mới là quan trọng.', topicId: '3', topicName: 'Business', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
  { id: 's3', english: 'Life is what happens when you are busy making other plans.', vietnamese: 'Cuộc sống là những gì xảy ra khi bạn đang bận rộn với những kế hoạch khác.', topicId: '5', topicName: 'Daily Life', difficulty: Difficulty.Medium, isLearned: false, createdAt: today, updatedAt: today },
  { id: 's4', english: 'The implementation of the new policy has acted as a catalyst for unprecedented economic growth.', vietnamese: 'Việc thực thi chính sách mới đã đóng vai trò như một chất xúc tác cho sự tăng trưởng kinh tế chưa từng có.', topicId: '4', topicName: 'Science', difficulty: Difficulty.Hard, isLearned: false, createdAt: today, updatedAt: today },
  { id: 's5', english: 'Despite the severe turbulence, the pilot managed to land the aircraft safely.', vietnamese: 'Bất chấp sự nhiễu loạn không khí nghiêm trọng, phi công vẫn xoay sở hạ cánh máy bay an toàn.', topicId: '1', topicName: 'Travel', difficulty: Difficulty.Hard, isLearned: true, createdAt: today, updatedAt: today },
];
